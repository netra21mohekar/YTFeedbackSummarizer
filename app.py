...
from text_summary import YouTubeCommentX
...
@app.route('/YouTubeCommentX')
def YouTubeCommentX_route():
...
def analyze():
    if request.method == 'POST':
        ...
        if google_sheet:
            ...
            summary, original_txt, len_orig_txt, len_summary = YouTubeCommentX(data)
...
def time_upload_file():
    ...
    if uploaded_file.filename != '':
        file_path = 'YouTubeCommentX/uploads/' + uploaded_file.filename
